...
const props = defineProps(['flattenedUsers'])
...
onMounted(() => {
  // Set the default sorting order to descending when the component is mounted
  ascending.value = true
  sortColumn.value = 'name'
  setTimeout(() => {
    sortTable(sortColumn.value)
  }, 1000)
})
</script>
